...
-- Adicionar coluna category_id à tabela receivable_payments se não existir
ALTER TABLE public.receivable_payments 
ADD COLUMN IF NOT EXISTS category_id UUID REFERENCES public.categories(id) ON DELETE SET NULL;

-- Atualizar a função para criar próximos pagamentos recorrentes para incluir category_id

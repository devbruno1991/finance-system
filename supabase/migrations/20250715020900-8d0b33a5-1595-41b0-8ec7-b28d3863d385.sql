...
-- Add missing columns to receivable_payments table to match debts functionality
...
-- Update the create_next_recurring_payment function to use the new structure
...
-- Create function to automatically update overdue receivable payments
